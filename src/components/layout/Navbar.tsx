  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/70 dark:bg-card/80 backdrop-blur-xl shadow-lg shadow-black/5 border-b border-white/20 dark:border-border/50"
          : "bg-white/50 dark:bg-black/30 backdrop-blur-lg border-b border-white/30 dark:border-white/10"
      }`}
    >
